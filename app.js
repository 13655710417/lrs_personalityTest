        ...
        app.innerHTML = `
            <div class="fade-in max-w-4xl mx-auto">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
                    <div class="bg-white p-6 rounded-xl shadow-sm border border-gray-200">
                        <h3 class="text-xl font-bold text-gray-800 mb-4">分享结果</h3>
                        <p class="text-gray-600 mb-4">${frontendText.shareText.replace('【XXX】', personality.name)}</p>
                        <div class="flex space-x-4">
                            <button onclick="shareResult('wechat')" class="btn bg-green-500 text-white py-3 px-6 rounded-lg hover:bg-green-600 flex-grow">
                                <i class="fab fa-weixin mr-2"></i>微信分享
                            </button>
                            <button onclick="shareResult('weibo')" class="btn bg-red-500 text-white py-3 px-6 rounded-lg hover:bg-red-600 flex-grow">
                                <i class="fab fa-weibo mr-2"></i>微博分享
                            </button>
                        </div>
                    </div>
                    <div class="bg-white p-6 rounded-xl shadow-sm border border-gray-200">
                        <h3 class="text-xl font-bold text-gray-800 mb-4">重新测试</h3>
                        <p class="text-gray-600 mb-4">想看看不同的选择会带来什么结果吗？重新测试看看！</p>
                        <button onclick="restartTest()" class="btn bg-gradient-to-r from-purple-500 to-pink-600 text-white py-3 px-8 rounded-lg hover:from-purple-600 hover:to-pink-700 w-full">
                            <i class="fas fa-redo mr-2"></i>${frontendText.buttons.retry}
                        </button>
                    </div>
                </div>

                <div class="text-center">
                    <button onclick="goHome()" class="btn bg-gray-200 text-gray-800 font-bold py-3 px-8 rounded-lg hover:bg-gray-300 mr-4">
                        <i class="fas fa-home mr-2"></i>返回首页
                    </button>
                    <button onclick="viewAllPersonalities()" class="btn bg-gradient-to-r from-blue-500 to-indigo-600 text-white font-bold py-3 px-8 rounded-lg hover:from-blue-600 hover:to-indigo-700">
                        <i class="fas fa-list mr-2"></i>查看全部30种人格
                    </button>
                </div>
            </div>
        `;
